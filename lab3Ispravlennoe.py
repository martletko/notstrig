    ...
    if num1 == 1: # Зашифровать/Расшифровать
        ...
        if num1_1 == 1: #зашифровать/расшифровать -> зашифровать
            ...
            if num_of_shifr == 1: #замена
                ...
                while flag1:
                    y = 0
                    filepath = input("введите название для файла txt... ")
        ...
        if num_of_shifr == 1: # шифр замена
            ...
            while flag1:
                ...
                if keypath == ".key":
                    print("не принимаются имена формата .key")
                    y += 1
            ...
            while flag1:
                ...
                if key_name == ".key":
                    print("нельзя вводить пустое имя типа .key")
                    y += 1
            ...
            while flag1:
                ...
                if key_name == '.key':
                    print("нельзя вводить пустое имя .key")
                    y += 1
